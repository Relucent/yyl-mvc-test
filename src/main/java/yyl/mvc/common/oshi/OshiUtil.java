...
public class OshiUtil {
	 ...
	 * @return 网络带宽信息
	 */
	public static List<DiskInfo> getDiskStoreInfo() {
	 ...
	 * @return 标记差
	 */
	private static long getTickDifference(long[] previousTicks, long[] currentTicks,
			CentralProcessor.TickType tickType) {
