...
public class PropertyFilter {
	...
	protected static PropertyFilter parse(final String filterName, final String filterValue) {
		...
		MatchType matchType = StringUtils.isEmpty(first) ? MatchType.EQ
				: ConvertUtil.toEnum(first, MatchType.class, MatchType.EQ);
	...
	protected boolean revisePropertyValue() {
		...
		if (!ConvertUtil.isSimpleType(propertyClass)) {
			return false;
		}
