...
public class HibernateGenericDao extends HibernateDaoSupport {
     ...
     */
    @SuppressWarnings("unchecked")
    public <T> T getByQuery(@SuppressWarnings("rawtypes") final Query query) {
    ...
    protected Integer getCountByCriteria(Criteria criteria) {
        ...
        ;
        try {
            orderEntries = (List) FieldUtil.getFieldValue(impl, "orderEntries");
            FieldUtil.setFieldValue(impl, "orderEntries", new ArrayList());
        } catch (Exception e) {
        ...
        try {
            ...
            if (projection instanceof ProjectionList) {
                ...
                // 获取SESSION实现
                SharedSessionContractImplementor sessionImplementor = impl.getSession();
            ...
            try {
                FieldUtil.setFieldValue(impl, "orderEntries", orderEntries);
            } catch (Exception e) {
                throw new InternalError(" Runtime Exception impossibility throw ");
            }
            if (firstResult != null) {
